...
<body>
  ...
  <form class="ui-dialog " id="dialog-Login" method="post" action="checkLogin.jsp?mid=<%=mid %>"  onselectstart='return false;' style="display: block;">
    ...
    <div class="ui-dialog-content">
      ...
      <div class="ui-dialog-40 ui-dialog-pt15">
        <input class="ui-dialog-input ui-dialog-input-password" id="login_password" name="password"  value="<%=password%>" type="text" onfocus="this.type='password'" placeholder="密码">
      </div>
      <div>
        <input type="submit" name="login" class="ui-dialog-submit" value="登录" id="to_login">
      </div>
      <div class="ui-dialog-40 clearfx">
        <a href="index.jsp" style="float: left">回到首页</a>
